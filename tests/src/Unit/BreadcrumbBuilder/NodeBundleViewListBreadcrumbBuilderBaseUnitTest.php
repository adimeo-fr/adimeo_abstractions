...
use Drupal\adimeo_abstractions\BreadcrumbBuilder\NodeBundleViewListBreadcrumbBuilderBase;
use Drupal\adimeo_abstractions\Constants\RoutesDefinitions;
use Drupal\Core\Breadcrumb\Breadcrumb;
use Drupal\Core\Routing\RouteMatch;
use Drupal\node\Entity\Node;
use Drupal\Tests\UnitTestCase;
use function Drupal\Tests\adimeo_abstractions\Unit\sizeof;
 ...
 */
class NodeBundleViewListBreadcrumbBuilderBaseUnitTest extends UnitTestCase {
  ...
  /**
   * @var NodeBundleViewListBreadcrumbBuilderBase
   */
  ...
  protected function buildArticleBreadcrumbBuilderMock() {
    $breadcrumbBuilder = $this->getMockForAbstractClass(NodeBundleViewListBreadcrumbBuilderBase::class);
  ...
  /**
   * @covers \Drupal\adimeo_abstractions\BreadcrumbBuilder\NodeBundleViewListBreadcrumbBuilderBase::applies
   * @author adimeo
  ...
  /**
   * @covers \Drupal\adimeo_abstractions\BreadcrumbBuilder\NodeBundleViewListBreadcrumbBuilderBase::build
   * @author adimeo
   * @group adimeoAbstractions
   * @group breadcrumbBuilder
   */
